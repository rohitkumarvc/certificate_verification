        ...
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-light m-0">
                    ...
                    <a href="personality_development_courses.html" class="dropdown-item">Personality Development Courses</a>
                    <a href="#" class="dropdown-item">Course Certificate</a>
                </div>
            </div>
            <a href="activities.html" class="nav-item nav-link">Our Activities</a>
...
<!-- Navbar End -->
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Your Certificate</h1>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <p class="fs-1 fw-bold text-primary">Details</p>
                    <p class="fs-5 fw-bold text-primary">Name: <?php echo "$name"; ?></p>
                    <p class="fs-5 fw-bold text-primary">Registation No.: <?php echo "$reg"; ?></p>
                    <p class="fs-5 fw-bold text-primary">Email: <?php echo "$email"; ?></p>
                    <a href = "data:image/png;charset=utf8;base64,<?php ;
                    echo base64_encode($certificate); ?>" type="button" class="btn btn-outline-primary" download="<?php echo "$reg"; ?>">Download Certificate</a>
                    <a href = "logout.php" type="button" class="btn btn-outline-danger">Logout</a>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s" style="min-height: 450px;">
                    <p class="fs-5 fw-bold text-primary">Your Certificate</p>
                    <img width="100%"src="data:image/png;charset=utf8;base64,<?php ;
                    echo base64_encode($certificate); ?>" alt="" class = "image-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="personality_development_courses.html">Personality Development Courses</a>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>Improve your Competence, Culture and Character</p>
